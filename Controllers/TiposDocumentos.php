...
class TiposDocumentos extends Controller
{
    ...
    public function listar()
    {
        ...
        $result = $this->model->getTiposDocumentos($start, $length, $search);
    ...
    public function registrar()
    {
        ...
        if (strpos($codigo, ' ') !== false) {
            ...
            $data = $this->model->registrarTipoDocumento($codigo, $nombre, $codigoUsuario);
            if ($data == "ok") {
                $msg = "si";
            } else if ($data == "existe") {
    ...
    public function modificar()
    {
        ...
        if (empty($codigo) || empty($nombre)) {
            ...
            $data = $this->model->modificarTipoDocumento($nombre, $codigoUsuario, $codigo);
            if ($data == "modificado") {
                $msg = "modificado";
            } else {
    ...
    {
        $data = $this->model->editarTipoDocumento($codigo);
